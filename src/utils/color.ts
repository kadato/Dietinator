/**
 * Convert a hex color (with optional alpha suffix like "#0f766e22") into an
 ...
 * of `tint` (0 to 1). Use instead of alpha when the result must stay opaque,
 * because translucent fills let content behind them bleed through (toast cards).
 */
