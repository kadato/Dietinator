  ...
  return (
    ...
    >
      <ModalContainer maxWidth={560}>
        <Box className="flex-row items-center gap-3 px-5 pt-5 pb-3">
        ...
        >
          <Text size="sm" className="text-typography-500 leading-[20px] mb-3">
            A new version of Dietinator is ready. Your diary, meals and settings
            stay on this device — updating never touches your data.
          </Text>

          {release.notes?.trim() ? (
            <>
              <Text size="xs" bold className="text-typography-500 uppercase tracking-wide mb-2">
                What's new
              </Text>
          ...
          {!apk ? (
            <Text size="sm" className="text-typography-500 mt-3">
